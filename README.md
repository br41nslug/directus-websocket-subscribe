...
- `AUTO_SUBSCRIPTION_COLLECTIONS: 'custom_collection_1,custom_collection_2'`\
  Choose the collections you want every websocket user to be automatically subscribed to.
...
```json
{
  "type": "post",
  "collection": "test",
  "data": [{ "test": "test123" }, { "test": "test456" }]
}
```
